...
class String():
    """
    we just recreate the functions string module to use in flashtext library
    to avoid using brython string library because of the re module is use.
    This module slows the loading of the string module
    """
    digits = '0123456789'
